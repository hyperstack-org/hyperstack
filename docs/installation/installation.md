...
You can install a single `HyperComponent` or the complete 'Stack  in your Rails app using the built in generators and Rake tasks.  You can also manually install the pieces following the detailed guide below.
