...
Gem::Specification.new do |s|
  ...
  s.add_dependency 'hyper-component', '0.15.0-sachsenring-lap2'
  s.add_dependency 'hyper-operation', '0.15.0-sachsenring-lap2'
  s.add_development_dependency 'bundler'
  s.add_development_dependency 'capybara'
  s.add_development_dependency 'chromedriver-helper'
  s.add_development_dependency 'database_cleaner'
  s.add_development_dependency 'factory_girl_rails'
  s.add_development_dependency 'hyper-spec', '0.15.0-sachsenring-lap2'
  ...
  s.add_development_dependency 'react-rails', '~> 2.4.0'
