...
Gem::Specification.new do |s|
  ...
  s.add_dependency 'hyper-component', '0.15.0-sachsenring-lap5'
  s.add_dependency 'hyper-operation', '0.15.0-sachsenring-lap5'
  s.add_development_dependency 'bundler'
  s.add_development_dependency 'capybara'
  s.add_development_dependency 'chromedriver-helper'
  s.add_development_dependency 'database_cleaner'
  s.add_development_dependency 'factory_girl_rails'
  s.add_development_dependency 'hyper-spec', '0.15.0-sachsenring-lap5'
  s.add_development_dependency 'hyper-trace'
  s.add_development_dependency 'jquery-rails'
  s.add_development_dependency 'mysql2'
  s.add_development_dependency 'opal-activesupport', '~> 0.3.0'
  s.add_development_dependency 'opal-browser', '~> 0.2.0'
  ...
  s.add_development_dependency 'rspec-steps', '~> 2.1.1'
