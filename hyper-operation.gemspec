...
Gem::Specification.new do |spec|
  ...
  spec.add_dependency 'hyper-component', '0.15.0-autobahn-a7'
  spec.add_dependency 'hyperloop-config', '0.15.0-autobahn-a7'
  spec.add_dependency 'mutations'
  spec.add_dependency 'opal-activesupport'
  spec.add_development_dependency 'bundler'
  spec.add_development_dependency 'database_cleaner'
  spec.add_development_dependency 'hyper-react', '0.15.0-autobahn-a7'
  spec.add_development_dependency 'hyper-spec', '0.15.0-autobahn-a7'
