    ...
    if RUBY_ENGINE != 'opal'
      ...
      prerender_footer do |controller|
        ...
        "<script type='text/javascript'>\n"\
          ...
          "Opal.HyperRecord.$const_get('ClientDrivers').$initialize_client_drivers_on_boot();\n"\
        "</script>\n"
      end
        ...
        if on_opal_client?
          ...
          when :pusher
            ...
            @opts[:pusher][:channel].JS.bind('update', `function(data){
              return Opal.HyperRecord.$const_get('ClientDrivers').$process_notification(Opal.Hash.$new(data));
            }`)
