...
/* modified to prevent multiple loads - works around problem with react.rb and opal-rails only use in test environment */
(
  function(f){
    //if (Config["env"] != "test") {
    //  console.log("!!!!!!!!!caution!!!!!!!!!!!! running modified version of react.js to avoid multiple react loads while running tests - use in test environment only")
    //}
    var g;
    ...
    if(!g.React) {
      console.log("running modified version of react.js")
