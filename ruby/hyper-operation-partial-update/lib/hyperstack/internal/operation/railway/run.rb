    ...
    module Operation
      class Railway
        ...
        class << self
          ...
          def abort!(arg)
            raise Hyperstack::Operation::Exit.new(:failed, arg)
          end

          def succeed!(arg)
            raise Hyperstack::Operation::Exit.new(:success, arg)
          end
        end
        ...
        def apply(opts, in_promise = nil)
          ...
          @last_result
        rescue Hyperstack::Operation::Exit => e
          @state = e.state
        ...
        rescue Hyperstack::Operation::Exit
        end
