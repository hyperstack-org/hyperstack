...
describe "regulate class connections" do
  ...
  it "will fail if there is no connection policy for a class" do
    ...
    expect { Hyperloop::InternalPolicy.regulate_connection(nil, "Application") }.to raise_error('connection failed')
  end

  it "will succeed if there is a connection policy for a class" do
    ApplicationPolicy.regulate_class_connection { true }
    expect { Hyperloop::InternalPolicy.regulate_connection(nil, "Application") }.not_to raise_error
  end

  it "the class connection policy ignores the acting_user object" do
    ApplicationPolicy.regulate_class_connection { true }
    expect { Hyperloop::InternalPolicy.regulate_connection("acting_user", "Application") }.not_to raise_error
  end
  ...
  it "can be applied to a different class" do
    ...
    expect { Hyperloop::InternalPolicy.regulate_connection(nil, "Class1") }.not_to raise_error
    expect { Hyperloop::InternalPolicy.regulate_connection(nil, "Class2") }.not_to raise_error
    expect { Hyperloop::InternalPolicy.regulate_connection(nil, "Application") }.to raise_error('connection failed')
  end
  ...
  it "can conditionally regulate the connection" do
    ...
    expect { Hyperloop::InternalPolicy.regulate_connection(true, "Application") }.not_to raise_error
    expect { Hyperloop::InternalPolicy.regulate_connection(nil, "Application") }.to raise_error('connection failed')
  end
  ...
  it "can conditionally regulate the connection by raising an error" do
    ...
    expect { Hyperloop::InternalPolicy.regulate_connection("okay", "Application") }.not_to raise_error
    expect { Hyperloop::InternalPolicy.regulate_connection("dokey", "Application") }.to raise_error('connection failed')
  end
